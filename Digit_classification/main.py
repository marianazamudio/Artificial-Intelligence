...
digits_images_tr, idx_digits_change_tr = dataset.obtain_images(train_lb, train_im, 60000, 1)
digits_images_te, idx_digits_change_te = dataset.obtain_images(test_lb, test_im, 10000, 1)

# Create array with possible desired outputs
...
MSE_values = perc_mult_layer.train_perceptron_mult(eta, alpha, num_epochs, \
                                    ...
                                    class_indx= idx_digits_change_tr, desired_out_list = d_list)
